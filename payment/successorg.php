...
mysqli_close($con);
       ...
       if ($hash != $posted_hash) {
          ...
          echo "<img src='images/oops.png' align='right'></img></div>";
	       ...
	       echo "<h2><font color='red' >Invalid Transaction. Please try again</font></h2>";
		   }
	   else {
          echo "<div id='donate'>";
          echo "<img src='images/.png' align='right'></img></div>";
 	   		
          echo "<h3>Thank You. Your Transaction status is ". $status .".</h3>";
          echo "<h4>Your Transaction ID for this transaction is<h2><font color='orange'> ".$txnid.".</font></h2></h4>";
          echo "<h4>We have received a payment of Rs. <h3>" . $amount . ". </h3> Thank You for Donating...</h4>";
